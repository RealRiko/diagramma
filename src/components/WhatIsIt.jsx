  ...
  return (
    <article className="slide">
      ...
      <section>
        ...
        <p>Lai to izveidotu, jums būs jāizmanto specializētu simbolu un savienotāju komplekts. Efektīva lietošanas gadījumu diagramma var palīdzēt jūsu </p>
         <p> komandai apspriest un pārstāvēt:</p>
        <ul>
